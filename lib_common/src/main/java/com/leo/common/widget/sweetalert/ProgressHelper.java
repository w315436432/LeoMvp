...
public class ProgressHelper {
    ...
    public ProgressHelper(Context ctx) {
        ...
        mBarColor = ctx.getResources().getColor(R.color.common_success_stroke_color);
        mRimWidth = 0;
        mRimColor = 0x00000000;
        mIsInstantProgress = false;
        mProgressVal = -1;
        mCircleRadius = ctx.getResources().getDimensionPixelOffset(R.dimen.common_progress_circle_radius);
    }
