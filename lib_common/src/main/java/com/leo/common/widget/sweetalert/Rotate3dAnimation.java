...
public class Rotate3dAnimation extends Animation {
    ...
    public Rotate3dAnimation (Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.common_Rotate3dAnimation);

        mFromDegrees = a.getFloat(R.styleable.common_Rotate3dAnimation_common_fromDeg, 0.0f);
        mToDegrees = a.getFloat(R.styleable.common_Rotate3dAnimation_common_toDeg, 0.0f);
        mRollType = a.getInt(R.styleable.common_Rotate3dAnimation_common_rollType, ROLL_BY_X);
        Description d = parseValue(a.peekValue(R.styleable.common_Rotate3dAnimation_common_pivotX));
        mPivotXType = d.type;
        mPivotXValue = d.value;

        d = parseValue(a.peekValue(R.styleable.common_Rotate3dAnimation_common_pivotY));
        mPivotYType = d.type;
