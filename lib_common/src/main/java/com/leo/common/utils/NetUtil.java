...
public class NetUtil {
    ...
    private static int NET_CNNT_BAIDU_TIMEOUT = 2; // no NetworkAvailable
    private static int NET_NOT_PREPARE = 3; // Net no ready
    private static int NET_ERROR = 4; //net error
